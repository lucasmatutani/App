...
if (!empty($linha)) {
    $sql = "UPDATE diagnostico set usuario_id='$usuario_id', representante='$representante', nome='$nome', case_diag='$case_diag', grupo='$grupo', problemas='$problemas', oportunidade='$oportunidade', objetivo='$objetivo' WHERE usuario_id= $usuario_id";
} 
// else {
