...
<body>
    ...
    ?>
        ...
        <div class="container-principal" style="display:flex; justify-content: center; align-items: center;">
            <div class="container-pergunta" style="width: 95vw;">
                ...
                <textarea name="txt48" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt59']; ?></textarea>
                <textarea name="txt49" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt60']; ?></textarea>
                <textarea name="txt50" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt51']; ?></textarea>
                <textarea name="txt51" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt62']; ?></textarea>
                <textarea name="txt52" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt63']; ?></textarea>
                <textarea name="txt53" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt64']; ?></textarea>
                <textarea name="txt54" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt65']; ?></textarea>
                <textarea name="txt55" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt66']; ?></textarea>
                <textarea name="txt56" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt67']; ?></textarea>
                <textarea name="txt57" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt68']; ?></textarea>
                <textarea name="txt58" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt69']; ?></textarea>
                ...
                <textarea name="txt48" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt70']; ?></textarea>
                <textarea name="txt49" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt71']; ?></textarea>
                <textarea name="txt50" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt72']; ?></textarea>
                <textarea name="txt51" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt73']; ?></textarea>
                <textarea name="txt52" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt74']; ?></textarea>
                <textarea name="txt53" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt75']; ?></textarea>
                <textarea name="txt54" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt76']; ?></textarea>
                <textarea name="txt55" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt77']; ?></textarea>
                <textarea name="txt56" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt78']; ?></textarea>
                <textarea name="txt57" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt79']; ?></textarea>
                <textarea name="txt58" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt80']; ?></textarea>
                ...
                <textarea name="txt48" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt81']; ?></textarea>
                <textarea name="txt49" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt82']; ?></textarea>
                <textarea name="txt50" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt83']; ?></textarea>
                <textarea name="txt51" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt84']; ?></textarea>
                <textarea name="txt52" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt85']; ?></textarea>
                <textarea name="txt53" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt86']; ?></textarea>
                <textarea name="txt54" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt87']; ?></textarea>
                <textarea name="txt55" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt88']; ?></textarea>
                <textarea name="txt56" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt89']; ?></textarea>
                <textarea name="txt57" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt90']; ?></textarea>
                <textarea name="txt58" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt91']; ?></textarea>
                ...
                <textarea name="txt64" id="" cols="30" rows="5"><?php if (!empty($row)) echo $row['txt92']; ?></textarea>
            </div>
        </div>
