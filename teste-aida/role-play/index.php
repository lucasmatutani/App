            ...
            ?>
                        <table cellpadding="30">
                            <tr style="text-align: left;">
                                ...
                                <th class="th-nmr1"><?php echo $row['valor_total'] ?></th>
                            </tr>
...
<script>
    function editar($row) {
        ...
        console.log(localStorage['grupo_escolhido']);
        // window.location.href = 'http://focustradeapp.com.br/teste-aida/respostas/';
    }
</script>