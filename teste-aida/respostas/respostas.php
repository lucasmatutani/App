...
if ($conn) {
    if (!empty($feedback1) || !empty($feedback2) || !empty($feedback3) || !empty($feedback4)) {
        $sql = "UPDATE teste_aida SET feedback1 = '$feedback1', feedback2 = '$feedback2', feedback3 = '$feedback3', valor_total = $valor_total, radio_total = '$radio_total' WHERE id = $user_id";
    }
