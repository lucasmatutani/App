...
<body>
    <form action="./respostas.php" method="POST">
        ...
        <div class="container-prod">
            <h2 id="prod1" onclick="prod1()"><?php if (!empty($linha)) echo $linha['nm1']; ?></h2>
            <h2 id="prod2" onclick="prod2()"><?php if (!empty($linha)) echo $linha['nm2']; ?></h2>
            <h2 id="prod3" onclick="prod3()"><?php if (!empty($linha)) echo $linha['nm3']; ?></h2>
            <h2 id="prod4" onclick="prod4()"><?php if (!empty($linha)) echo $linha['nm4']; ?></h2>
        </div>
        ...
        <div class="container-resposta" id="container1">
            ...
            <div class="container-atencao">
                ...
                <textarea readonly name="atencao" id="txt1" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt1']; ?></textarea>
            </div>
            ...
            <div class="container-interesse">
                ...
                <textarea readonly name="interesse" id="txt2" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt2']; ?></textarea>
            </div>
            <div class="btns-radios">
            ...
            <div class="container-desejo">
                ...
                <textarea readonly name="desejo" id="txt3" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt3']; ?></textarea>
            </div>
            <div class="btns-radios">
            ...
            <div class="container-acao">
                ...
                <textarea readonly name="acao" id="txt4" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt4']; ?></textarea>
            </div>
            <div class="btns-radios">
        ...
        <div class="container-resposta" id="container2" style="display: none;">
            ...
            <div class="container-atencao">
                <label for="">ATENÇÃO</label>
                <textarea readonly name="atencao2" id="txt5" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt5']; ?></textarea>
            </div>
            <div class="btns-radios">
            ...
            <div class="container-interesse">
                <label for="">INTERESSE</label>
                <textarea readonly name="interesse" id="txt6" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt6']; ?></textarea>
            </div>
            <div class="btns-radios">
            ...
            <div class="container-desejo">
                <label for="">DESEJO</label>
                <textarea readonly name="desejo" id="txt7" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt7']; ?></textarea>
            </div>
            <div class="btns-radios">
            ...
            <div class="container-acao">
                <label for="">AÇÃO</label>
                <textarea readonly name="acao" id="txt8" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt8']; ?></textarea>
            </div>
            <div class="btns-radios">
            ...
            <div class="container-feedback">
                <label for="">FEEDBACK</label>
                <textarea name="feedback2" id="feedback2" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['feedback2']; ?></textarea>
            </div>
        ...
        <div class="container-resposta" id="container3" style="display: none;">
            ...
            <div class="container-atencao">
                <label for="">ATENÇÃO</label>
                <textarea readonly name="atencao" id="txt9" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt9']; ?></textarea>
            </div>
            <div class="btns-radios">
            ...
            <div class="container-interesse">
                <label for="">INTERESSE</label>
                <textarea readonly name="interesse" id="txt10" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt10']; ?></textarea>
            </div>
            <div class="btns-radios">
            ...
            <div class="container-desejo">
                <label for="">DESEJO</label>
                <textarea readonly name="desejo" id="txt11" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt11']; ?></textarea>
            </div>
            <div class="btns-radios">
            ...
            <div class="container-acao">
                <label for="">AÇÃO</label>
                <textarea readonly name="acao" id="txt12" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt12']; ?></textarea>
            </div>
            <div class="btns-radios">
            ...
            <div class="container-feedback">
                <label for="">FEEDBACK</label>
                <textarea name="feedback3" id="feedback3" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['feedback3']; ?></textarea>
            </div>
        ...
        <div class="container-resposta" id="container4" style="display: none;">
            ...
            <div class="container-atencao">
                <label for="">ATENÇÃO</label>
                <textarea readonly name="atencao" id="txt13" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt13']; ?></textarea>
            </div>
            <div class="btns-radios">
            ...
            <div class="container-interesse">
                <label for="">INTERESSE</label>
                <textarea readonly name="interesse" id="txt14" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt14']; ?></textarea>
            </div>
            <div class="btns-radios">
            ...
            <div class="container-desejo">
                <label for="">DESEJO</label>
                <textarea readonly name="desejo" id="txt15" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt15']; ?></textarea>
            </div>
            <div class="btns-radios">
            ...
            <div class="container-acao">
                <label for="">AÇÃO</label>
                <textarea readonly name="acao" id="txt16" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['txt16']; ?></textarea>
            </div>
            <div class="btns-radios">
            ...
            <div class="container-feedback">
                <label for="">FEEDBACK</label>
                <textarea name="feedback4" id="feedback4" cols="130" rows="10"><?php if (!empty($linha)) echo $linha['feedback4']; ?></textarea>
            </div>
